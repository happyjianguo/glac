...
@Service
@StepScope
public class Sccc5600T01RemovalApGlBalHst implements Tasklet {

	private static final Logger log = LoggerFactory.getLogger(Sccc5600T01RemovalApGlBalHst.class);
