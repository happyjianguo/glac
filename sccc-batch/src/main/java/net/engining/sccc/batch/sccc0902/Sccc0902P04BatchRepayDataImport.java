...
@StepScope
@Validated
public class Sccc0902P04BatchRepayDataImport implements ItemProcessor<EveryDayAccountingBean, Object> {
	...
	@Override
	public Object process(EveryDayAccountingBean item) throws Exception {
		...
		// 业务数据检查
		bizValidatorService.validateBatchRepay(item);
		...
		btEodTxnImport.setTxnType(TxnTypeDef.BATREPA);
