...
@Service
@StepScope
public class Sccc0901P06NqhPostLedger implements ItemProcessor<BtNqhImport, Object> {

	private static final Logger logger = LoggerFactory.getLogger(Sccc0901P06NqhPostLedger.class);
	 ...
	 */
	@Override
	public Object process(BtNqhImport item) throws Exception {
