package net.engining.sccc.accounting.test.support;
...
import net.engining.sccc.accounting.AccountingMsvApplication;
...
@SpringBootTest(classes = AccountingMsvApplication.class)
