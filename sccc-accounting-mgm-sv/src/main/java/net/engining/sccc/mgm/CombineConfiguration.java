...
import net.engining.sccc.mgm.config.MgmWebSecurityExtContextConfig;
 ...
 */
@Configuration
@EnableSwagger2//打开swagger，访问/swagger-ui.html; 暂时加在顶层config上，解决swagger报错(Unable to infer base url)的坑，未找到正真原因，一度加在Swagger2ContextConfig是可行的，可能是与某个包冲突;
...
@Import(value = {
		...
		MgmWebSecurityExtContextConfig.class
		})
@ComponentScan(
		basePackages = {
